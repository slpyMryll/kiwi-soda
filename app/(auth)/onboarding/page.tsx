    ...
    <main className="min-h-screen w-full bg-surface-brand flex flex-col-reverse lg:flex-row items-stretch justify-center lg:px-14 lg:py-1 lg:gap-14">
      <section className="relative flex-1 bg-white rounded-t-[40px] lg:rounded-2xl px-8 py-10 lg:px-14 lg:py-8 shadow-2xl self-end lg:self-center w-full max-w-2xl mx-auto z-10 transition-all duration-500">
        ...
        <div className="text-center lg:text-left mb-8">
          <h1 className="text-2xl lg:text-3xl font-bold text-green-dark mb-2">Finish Setting Up</h1>
          <p className="text-gray-500 text-sm">Create a password to use the manual login form next time.</p>
        </div>

        <form onSubmit={handleComplete} className="space-y-6">
          <div className="flex flex-col space-y-2">
            <label className="text-sm font-bold text-green-dark ml-1 text-left">Full Name</label>
            <div className="relative group">
              <User className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors ${name ? 'text-green-600' : 'text-gray-400'}`} />
              <input
                type="text"
                required
          ...
          <div className="flex flex-col space-y-2">
            <label className="text-sm font-bold text-green-dark ml-1 text-left">Username</label>
            <div className="relative group">
              <AtSign className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors ${username ? 'text-green-600' : 'text-gray-400'}`} />
              <input
                type="text"
                required
          ...
          <div className="flex flex-col space-y-2">
            <label className="text-sm font-bold text-green-dark ml-1 text-left">Create Password</label>
            <div className="relative group">
