...
export function Footer() {
  return (
    <footer className="w-full bg-surface-brand text-white pt-16 pb-8 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-4 mb-14">
          <div className="flex flex-col items-start md:items-center text-left md:text-center">
            <h3 className="text-xl font-bold mb-6 text-white">OnTrack</h3>
            <p className="text-sm text-white/80 leading-relaxed max-w-55">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center justify-center md:justify-start gap-2 w-full md:w-1/3">
            ...
            <span className="font-bold text-white md:hidden">OnTrack</span>
          </div>
