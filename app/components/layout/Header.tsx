      ...
      <div className="h-full mx-auto px-4 lg:px-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Sheet>
            ...
            <SheetContent
              side="left"
              className="w-75 sm:w-87.5 bg-white p-0 overflow-y-auto border-r-0 [&>button]:hidden flex flex-col"
            >
              ...
              {user ? (
                  ...
                  {navItems.map((item, index) => {
                    if (item.divider)
                      return (
                        <div
                          key={`divider-${index}`}
                          className="h-px bg-gray-200/80 my-4 ml-4 mr-4"
                        />
                      );
                ...
                <div className="flex-1">
                  <div className="p-6 border-b border-gray-100">
                    <Button
                      asChild
                      className="w-full bg-[#1B4332] hover:bg-green-900 text-white shadow-md rounded-xl py-6 text-base"
                    >
          ...
          {user ? (
            <>
              ...
              <DropdownMenu modal={false}>
                ...
                <DropdownMenuContent
                  align="end"
                  className="w-72 p-2 bg-white rounded-xl shadow-lg border border-gray-200 mt-2"
                >
