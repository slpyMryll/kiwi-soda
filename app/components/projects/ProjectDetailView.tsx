...
export function ProjectDetailView({
  ...
  return (
    <div className={`flex flex-col bg-white ${isModal ? "" : "min-h-screen"}`}>
      ...
      {isPreview && (
        <div className="w-full bg-[#1B4332] text-white text-[13px] py-2 flex items-center justify-center gap-2 font-medium shadow-sm z-10">
          <Eye className="w-4 h-4 text-[#e1f0c2]" />
