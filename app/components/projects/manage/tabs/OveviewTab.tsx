        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="font-bold text-gray-900">2 of 4</span>
            </div>
            <div className="flex justify-between items-center text-sm">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
          ...
          <div className="relative border-l-2 border-gray-100 ml-3 space-y-6">
            <div className="relative pl-6">
              <div className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-green-500 border-4 border-white" />
              <p className="text-sm font-bold text-gray-900">Task Completed</p>
              <p className="text-xs text-gray-500">Equipment Procurement</p>
            ...
            <div className="relative pl-6">
              ...
              <p className="text-xs text-gray-500">
                Progress Report January.pdf
              </p>
              <p className="text-[10px] text-gray-400 mt-0.5">5 hours ago</p>
            </div>
            <div className="relative pl-6">
              <div className="absolute -left-[9px] top-1 w-4 h-4 rounded-full bg-orange-500 border-4 border-white" />
              <p className="text-sm font-bold text-gray-900">Budget Updated</p>
              <p className="text-xs text-gray-500">
                Equipment purchase recorded
              </p>
