    ...
    <div className="flex flex-col min-h-screen bg-bg-main">
      ...
      <div className="flex flex-1 relative">
        <div className="hidden lg:block">
          <ContentRail trendingTopics={["#Budget Transparency", "#Student Projects", "#SSC"]} />
        </div>
        ...
        <main className="flex-1 flex flex-col overflow-x-hidden bg-linear-to-b from-[#153B44] from-0% via-bg-main via-10% to-bg-main">
          <div className="px-4 lg:px-24 mx-auto w-full flex-1 ">
            ...
            <div className="mb-2 mt-8">
              <h2 className="text-2xl font-bold text-[#1B4332]">Project Dashboard</h2>
              <p className="text-sm text-gray-500">Explore and follow USSC Projects and Initiatives</p>
            </div>
