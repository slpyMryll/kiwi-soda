  ...
  return (
    <div className="flex flex-col min-h-screen bg-bg-main">
      ...
      <div className="flex flex-1 relative w-full mx-auto">
        ...
        <main className="flex-1 flex flex-col overflow-x-hidden bg-linear-to-b from-[#153B44] from-0% via-bg-main via-[300px] to-bg-main pb-[calc(64px+env(safe-area-inset-bottom))] md:pb-0">
